...
/**
 * Simple binary -> xml conversion to support import of binary extraction files
 * of LIRE.
 *
...
//        BitSampling.readHashFunctions(new FileInputStream("LshBitSampling.obj"));
        ...
        a.createXml(new File("/data/digitalcandy/"), new File("/data/digitalcandy/wipo_v10.out"));
    }
