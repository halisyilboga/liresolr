...
public class SearchImages {
    ...
    private static final String baseURL = "http://localhost:8983/solr/media_shard1_replica1/get";
...
class SolrResponseHandler extends DefaultHandler {
    ...
    private final ArrayList<ResultItem> results = new ArrayList<ResultItem>(500);
