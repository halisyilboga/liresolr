    ...
    private static void readHistogramBy(String paramUrl, String paramField) {
        ...
        try {
            ...
            if (paramField == null) {
                ...
                if (paramField.equals("cl_ha")) {
                    feat = new ColorLayout();
                } else if (paramField.equals("jc_ha")) {
                    feat = new JCD();
                } else if (paramField.equals("ph_ha")) {
                    feat = new PHOG();
                } else if (paramField.equals("oh_ha")) {
                    feat = new OpponentHistogram();
                } else if (paramField.equals("su_ha")) {
