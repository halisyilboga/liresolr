        ...
        if (imageList != null) {
            p = new ParallelIndexer(numThreads, indexPath, imageList) {
                ...
                public void addBuilders(ChainedDocumentBuilder builder) {
                    ...
                    builder.addBuilder(new GenericDocumentBuilder(FCTH.class, true));
                    builder.addBuilder(new GenericDocumentBuilder(JCD.class, true));
                    builder.addBuilder(new GenericDocumentBuilder(ScalableColor.class, true));
                    ...
                    builder.addBuilder(new GenericDocumentBuilder(Tamura.class, true));
                    builder.addBuilder(new GenericDocumentBuilder(Gabor.class, true));
                    builder.addBuilder(new GenericDocumentBuilder(SimpleColorHistogram.class, true));
                    builder.addBuilder(new GenericDocumentBuilder(JpegCoefficientHistogram.class, true));
                    ...
                    builder.addBuilder(new GenericDocumentBuilder(LuminanceLayout.class, true));
